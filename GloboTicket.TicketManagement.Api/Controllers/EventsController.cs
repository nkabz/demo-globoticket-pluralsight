...
namespace GloboTicket.TicketManagement.Api.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<ActionResult<EventDetailVm>> Create([FromBody] CreateEventCommand createEventCommand)
        {
            var createdId = await _mediator.Send(createEventCommand);
            return Ok(createdId);
        }        
        ...
        [ProducesDefaultResponseType]
        public async Task<ActionResult<EventDetailVm>> Update([FromBody] UpdateEventCommand updateEventCommand)
        {
